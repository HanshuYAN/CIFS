...
class ResNet(nn.Module):
    ...
    def predict_with_feats(self, x, which_feat):
        # N, C, _, _ = x.shape
        unmasked_feats = []
        ...
        if which_feat == 'probe_0' or which_feat == 'probe_0_masked':
            return out, unmasked_feats[0]
        elif which_feat == 'probe_1' or which_feat == 'probe_1_masked':
...
def ResNet_Gray_10(num_classes=10):
    return ResNet(BasicBlock, [1,1,1,1], num_classes=num_classes, in_channels=1)
