...
class ResNet_L4(nn.Module):
    ...
    def forward(self, x, y=None):
        ...
        return out, pred_cas_list # 51.23
        # return out/.1, pred_cas_list # beta=2, PGD20, 51.74
        # return out/.5, pred_cas_list # beta=2, PGD20, 51.42
        # return out/5, pred_cas_list # beta=2, PGD20, 50.21
        # return out/10, pred_cas_list # beta=2, PGD20, 50.17
...
class ResNet10_3_4(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, in_channels=3):
        ...
        self.Probe_0 = CSAFR(256, num_classes, mode='nolinear')
        self.Probe_1 = CSAFR(512, num_classes, mode='linear')
    ...
    def forward(self, x, y=None):
        ...
        out, pred_cas = self.Probe_0(out, y); pred_cas_list.append(pred_cas)
        
        out = self.layer4(out)
        
        out, pred_cas = self.Probe_1(out, y); pred_cas_list.append(pred_cas)
    ...
    def predict_with_feats(self, x, y=None, which_feat=None):
        ...
        out, pred_cas = self.Probe_0(out, y); masked_feats.append(out.detach().clone())
        
        out = self.layer4(out); unmasked_feats.append(out.detach().clone())
        out, pred_cas = self.Probe_1(out, y); masked_feats.append(out.detach().clone())
